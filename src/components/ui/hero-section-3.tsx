...
export function HeroSection({ loginButton, error }: HeroSectionProps) {
    return (
        <>
            <HeroHeader />
                ...
                <section>
                    <div className="relative mx-auto max-w-6xl px-6 pt-32 lg:pb-16 lg:pt-48">
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            ...
                            >
                                <h1
                                    className="text-balance text-4xl font-bold sm:text-5xl md:text-6xl text-gray-900">
                                    Master Your Learning Journey
                                </h1>

                                <p className="mx-auto mt-6 max-w-2xl text-pretty text-lg text-gray-700">
                                    AI-powered student review app for Singapore students. Upload exam papers, extract wrong questions, and track your progress across all subjects with intelligent explanations.
                                </p>

                                {/* Error Message */}
                                {error && (
                                    <div className="mt-6 mx-auto max-w-md p-4 bg-red-50 border border-red-200 rounded-lg">
                                ...
                                >
                                    <div className="bg-background border-border/50 absolute inset-0 mx-auto w-80 -translate-x-3 -translate-y-12 rounded-[2rem] p-2 [mask-image:linear-gradient(to_bottom,#000_50%,transparent_90%)] sm:-translate-x-6">
                                        <div className="relative h-96 overflow-hidden rounded-[1.5rem] p-2 pb-12 before:absolute before:inset-0 before:bg-[repeating-linear-gradient(-45deg,var(--border),var(--border)_1px,transparent_1px,transparent_6px)] before:opacity-50"></div>
                                    </div>
                                    <div className="bg-muted dark:bg-background/50 border-border/50 mx-auto w-80 translate-x-4 rounded-[2rem] p-2 backdrop-blur-3xl [mask-image:linear-gradient(to_bottom,#000_50%,transparent_90%)] sm:translate-x-8">
                                        <div className="bg-background space-y-2 overflow-hidden rounded-[1.5rem] p-2 shadow-xl dark:bg-white/5 dark:shadow-black dark:backdrop-blur-3xl">
                                            <AppComponent />
            ...
            <div className="group relative m-auto max-w-6xl px-6">
                <div className="flex flex-col items-center md:flex-row">
                    <div className="inline md:max-w-44 md:border-r md:pr-6">
                        <p className="text-end text-sm">Trusted by students from</p>
                    </div>
                    <div className="relative py-6 md:w-[calc(100%-11rem)]">
                        <InfiniteSlider
                            ...
                            gap={112}>
                            <div className="flex">
                                <div className="mx-auto h-5 w-fit text-sm font-medium dark:invert">National University</div>
                            </div>

                            <div className="flex">
                                <div className="mx-auto h-4 w-fit text-sm font-medium dark:invert">NTU</div>
                            </div>
                            <div className="flex">
                                <div className="mx-auto h-4 w-fit text-sm font-medium dark:invert">SMU</div>
                            </div>
                            <div className="flex">
                                <div className="mx-auto h-5 w-fit text-sm font-medium dark:invert">Raffles Institution</div>
                            </div>
                            <div className="flex">
                                <div className="mx-auto h-5 w-fit text-sm font-medium dark:invert">Hwa Chong</div>
                            </div>
                            <div className="flex">
                                <div className="mx-auto h-4 w-fit text-sm font-medium dark:invert">ACS</div>
                            </div>
                            <div className="flex">
                                <div className="mx-auto h-7 w-fit text-sm font-medium dark:invert">Victoria School</div>
                            </div>

                            <div className="flex">
                                <div className="mx-auto h-6 w-fit text-sm font-medium dark:invert">ACSI</div>
                            </div>
                        </InfiniteSlider>
