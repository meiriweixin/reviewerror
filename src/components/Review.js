    ...
    <div className="max-w-7xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          {/* Full uploaded images - deduplicated */}
          {(() => {
            const seen = new Set();
            const uniqueImages = [];
            questions.forEach((q) => {
            ...
            return uniqueImages.length > 0 ? (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {uniqueImages.map((img, idx) => (
                  ...
                  >
                    <div className="px-4 py-2 border-b border-gray-100 dark:border-slate-800 flex items-center gap-2">
                      <svg className="w-4 h-4 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                      <span className="text-xs text-gray-400 dark:text-gray-500">Uploaded paper</span>
                    </div>
