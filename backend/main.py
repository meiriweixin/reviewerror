...
from app.routers import auth, questions, stats, usage, users, papers, qa, subjects, notifications
...
app.include_router(papers.router, prefix="/papers", tags=["Paper Library"])
